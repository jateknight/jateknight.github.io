...
Tags: Basic, Bludgeoning, Fury, Physical, Damage, Crowd Control, Two-Handed.`,
	...
	"Enhanced Bash": {
		...
		description: `เมื่อใช้ Bash ทำความเสียหาย แก่ศัตรูที่ถูก Stun, จะได้รับ Fortify เป็นจำนวน 10% ของพลังชีวิต, เพิ่มจำนวนนี้เป็นสองเท่าเมื่อใช้อาวุธสองมือ.`,
		nameLocalized: {
	...
	"Battle Bash": {
		...
		description: `เมื่อใช้ Bash ทำความเสียหาย แก่ศัตรูที่ถูก Stun, จะได้รับ 3 Fury, หรือ 4 Fury เมื่อใช้อาวุธสองมือ.`,
		nameLocalized: {
			deDE: "Schlachthieb",
	...
	"Combat Bash": {
		baseSkill: "Bash",
		connections: ["Enhanced Bash"],
		description: `เมื่อใช้ Bash ทำความเสียหายแบบ Critical 4 ครั้งด้วยอาวุธสองมือ, สกิล Core หรือ Weapon Mastery ครั้งถัดไปจะ Overpower.`,
		nameLocalized: {
			deDE: "Kampfhieb",
